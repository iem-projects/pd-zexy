...
{
  eq_tilde_class = class_new(gensym("==~"), (t_newmethod)eq_tilde_new, 0, sizeof(t_eq_tilde), 0, A_GIMME, 0);
  ...
  scalareq_tilde_class = class_new(gensym("==~"), 0, 0, sizeof(t_scalareq_tilde), 0, 0);
